...
public class LdpcDecoder {
    ...
    public boolean[] Decode(boolean[] x, JWindow w, GraphicsPanel p){
        ...
        if(isEqual(z,zeros)) {
            System.out.println("zero syndrome");
            return x; //i,e syndrome is zero.
        }
        ...
        */
        ...
        for(int iterations = 0; iterations< Max_iterations; iterations++){
            ...
            if(isEqual(newSyndrome,z) == true){   
                ...
                System.out.println("return Hn=0");
                return result;
            }
        }
